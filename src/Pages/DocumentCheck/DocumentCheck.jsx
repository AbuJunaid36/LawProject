...
const DocumentCheck = () => {
  return (
    <div className="w-[90%] md:w-[80%] mx-auto mb-20 md:mb-0 flex items-center justify-center p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {["বিভাগ", "জেলা", "জরিপ", "থানা", "মৌজা"].map((label, index) => (
              <div key={index}>
                ...
                <select className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
